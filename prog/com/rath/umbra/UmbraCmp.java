/* UmbraCmp.java */
/* Generated By:JavaCC: Do not edit this line. UmbraCmp.java */
import java.io.*;
import java.util.List;
import java.util.ArrayList;

public class UmbraCmp implements UmbraCmpConstants {
...
{if ("" != null) return new ValueList(exprHead, exprList);}
  ...
  private boolean jj_3R_17()
 {
  ...
  public UmbraCmpTokenManager token_source;
  ...
  public UmbraCmp(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public UmbraCmp(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new UmbraCmpTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public UmbraCmp(java.io.Reader stream) {
  ...
  public UmbraCmp(UmbraCmpTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(UmbraCmpTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
